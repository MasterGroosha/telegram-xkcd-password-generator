...
def generate_weak_pwd():
    ...
    return xkcd_password.generate_xkcdpassword(wordlist=wordlist, numwords=2, delimiter="")


def generate_normal_pwd():
    # 3 words, no separators between words, second word is CAPITALIZED
    words = xkcd_password.generate_xkcdpassword(wordlist=wordlist, numwords=3, delimiter=" ").split()
...
def generate_stronger_pwd():
    ...
    words = xkcd_password.generate_xkcdpassword(wordlist=wordlist, numwords=4, delimiter=" ").split()
